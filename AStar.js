...
//mudar esse e o best first search(melhor escolha)//pois considera somente a euristica
...
async function AStar(map,final){
    ...
    while(lista.length>0){
        ...
        if(!(analisar.getCordX() == final.x && analisar.getCordY() == final.y)) {
            ...
            if(aux.moverPraCima()) {
                ...
                lista.push({"estado":auxPaddCusto ,"CE":(auxPaddCusto.custo+CustEstimAtual)});
